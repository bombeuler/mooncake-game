      ...
      <van-dialog v-model="show" title="游戏简介" confirm-button-color="#000">
        <div class="intro">
          <div class="dd">
            ...
            <div class="bb">
              考生快要考试了却还没有复习。为了拯救他(实则拿奖品)，你需要制作记忆月饼喂食考生让他拥有一个满意的分数。
            </div>
          </div>
          <div class="dd">
            ...
            <div class="bb">
              靠点击收集到足够的原料后，点击考生即可以给考生喂食记忆月饼并令考生的相应科目加10分，考生所有科目分数满足期望值时即成功。
            </div>
          ...
          <div class="dd">
            ...
            <div class="bb">
              每帮考生通过一次考试可以获得一定积分，在一定时间内完成会有额外分。
            </div>
          </div>
          <div class="dd">
            <div class="cc">特殊机制</div>
            <div class="bb">
              一次最多可收集30份面，30烧糖和5页书。超过限额则不可收集。有一定几率会收集到发霉的书页导致考生食物中毒。
            </div>
            <div class="bb">
              为了保护考生，如果当前收集了发霉的书页或者收集的书页对应不上考生当前要考的科目，需点击垃圾桶清空之前收集到的书页，否则点击考生将无效。
            </div>
          </div>
        </div>
      </van-dialog>
